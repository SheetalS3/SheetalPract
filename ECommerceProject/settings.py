...
SECRET_KEY = 'django-insecure-euqc1p0!feg@q0+(a6k!zf+s0=irriwgsx7b!i-g0ptzw(qy)r'
...
config.read(r"D:\Sheetal\Python\Scripting files\Django_Projects\ECommerceProject\ECommerceProject\database.conf")
